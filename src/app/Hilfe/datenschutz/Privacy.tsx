  ...
  return (
      <div className='flex justify-center w-full'>
          <div className='w-1/2'>
              ...
              <h3 className={styles.heading3}>Arten der verarbeiteten Daten</h3>
              <ul>
                  <li>Bestandsdaten.</li>
                  <li>Zahlungsdaten.</li>
                  <li>Standortdaten.</li>
              ...
              <p className={styles.paragraph}>
                  ...
                  erforderlich sind). Sofern die Daten nicht gelöscht werden,
                  ...
                  müssen oder deren Speicherung zur Geltendmachung, Ausübung
              ...
              <ul>
                  <li>
                      <strong>
                          ...
                          personenbezogenen Daten verarbeitet, um Direktwerbung
                          zu betreiben, haben Sie das Recht, jederzeit
              ...
              <p className={styles.paragraph}>
                  ...
                  erforderlichen Cookies gehören in der Regel Cookies mit
                  Funktionen, die der Anzeige und Lauffähigkeit des
                  Onlineangebotes , dem Lastausgleich, der Sicherheit, der
                  Speicherung der Präferenzen und Auswahlmöglichkeiten der
              ...
              <p className={styles.paragraph}>
                  ...
                  erfüllen. Zu welchen Zwecken die Cookies von uns verarbeitet
                  werden, darüber klären wir im Laufe dieser
              ...
              <ul>
                  ...
                  <li>
                      ...
                      der Nutzer zur Reichweitenmessung verwendet werden. Sofern
              ...
              <p className={styles.paragraph}>
                  ...
                  unter anderem die Verwendung von Cookies in den Einstellungen
                  ihres Browsers einschränken (wobei dadurch auch die
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      können. Vorbehaltlich individueller Angaben zu den
                      Anbietern von Cookie-Management-Diensten, gelten die
                      folgenden Hinweise: Die Dauer der Speicherung der
                      Einwilligung kann bis zu zwei Jahren betragen. Hierbei
                      wird ein pseudonymer Nutzer-Identifikator gebildet und mit
                      ...
                      <span className=''>
                          <strong>Rechtsgrundlagen:</strong> Einwilligung (Art.
              ...
              <p className={styles.paragraph}>
                  ...
                  Rechtsberatern, Zahlungsdienstleistern oder Finanzbehörden).
                  Im Rahmen des geltenden Rechts geben wir die Daten von
                  Vertragspartnern nur insoweit an Dritte weiter, als dies für
                  die vorgenannten Zwecke oder zur Erfüllung gesetzlicher
                  Pflichten erforderlich ist. Über weitere Formen der
                  Verarbeitung, z.B. zu Marketingzwecken, werden die
              ...
              <ul className='m-elements'>
                  ...
                  <li className=''>
                      ...
                      c) DSGVO). Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
                      f) DSGVO).
                  </li>
              </ul>
              <p className={styles.paragraph}>
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      Kunden hierauf ebenso hingewiesen wie auf die für die
                      Registrierung erforderlichen Angaben. Die Kundenkonten
                      sind nicht öffentlich und können von Suchmaschinen nicht
                      indexiert werden. Im Rahmen der Registrierung sowie
                      anschließender Anmeldungen und Nutzungen des Kundenkontos
                      speichern wir die IP-Adressen der Kunden nebst den
                      Zugriffszeitpunkten, um die Registrierung nachweisen und
                      etwaigem Missbrauch des Kundenkontos vorbeugen zu können.
                      Wurde das Kundenkonto gekündigt, werden die Daten des
                      Kundenkontos nach dem Kündigungszeitpunkt gelöscht, sofern
                      sie nicht für andere Zwecke als die Bereitstellung im
                      Kundenkonto aufbewahrt werden oder aus rechtlichen Gründen
                      aufbewahrt werden müssen (z.B. interne Speicherung von
                      Kundendaten, Bestellvorgängen oder Rechnungen). Es liegt
                      in der Verantwortung der Kunden, ihre Daten bei Kündigung
                      des Kundenkontos zu sichern;{' '}
                      <span className=''>
                  ...
                  <li>
                      <strong>Shop und E-Commerce: </strong>Wir verarbeiten die
                      Daten unserer Kunden, um ihnen die Auswahl, den Erwerb,
                      bzw. die Bestellung der gewählten Produkte, Waren sowie
                      verbundener Leistungen, als auch deren Bezahlung und
                      Zustellung, bzw. Ausführung zu ermöglichen. Sofern für die
                      Ausführung einer Bestellung erforderlich, setzen wir
                      Dienstleister, insbesondere Post-, Speditions- und
                      Versandunternehmen ein, um die Lieferung, bzw. Ausführung
                      gegenüber unseren Kunden durchzuführen. Für die Abwicklung
                      ...
                      vergleichbaren Erwerbsvorgangs gekennzeichnet und umfassen
                      die zur Auslieferung, bzw. Zurverfügungstellung und
                      Abrechnung benötigten Angaben sowie Kontaktinformationen,
              ...
              <p className={styles.paragraph}>
                  ...
                  und empfängerbezogenen Angaben. Die Angaben sind erforderlich,
                  um die Transaktionen durchzuführen. Die eingegebenen Daten
                  werden jedoch nur durch die Zahlungsdienstleister verarbeitet
                  und bei diesen gespeichert. D.h., wir erhalten keine konto-
              ...
              <p className={styles.paragraph}>
                  Für die Zahlungsgeschäfte gelten die Geschäftsbedingungen und
                  die Datenschutzhinweise der jeweiligen Zahlungsdienstleister,
                  welche innerhalb der jeweiligen Webseiten bzw.
                  Transaktionsapplikationen abrufbar sind. Wir verweisen auf
                  diese ebenfalls zwecks weiterer Informationen und
              ...
              <ul className='m-elements'>
                  ...
                  <li>
                      ...
                      einen zu Zwecken der Sicherheit eingesetzt werden, z.B.,
                      um eine Überlastung der Server zu vermeiden (insbesondere
                      im Fall von missbräuchlichen Angriffen, sogenannten
                      DDoS-Attacken) und zum anderen, um die Auslastung der
                  ...
                  <li>
                      <strong>E-Mail-Versand und -Hosting: </strong>Die von uns
                  ...
                  <li>
                      ...
                      &quot;Content-Delivery-Network&quot; (CDN) ein. Ein CDN
                      ist ein Dienst, mit dessen Hilfe Inhalte eines
              ...
              <p className={styles.paragraph}>
                  ...
                  des Nutzerkontos auf Grundlage vertraglicher Pflichterfüllung
              ...
              <p className={styles.paragraph}>
                  ...
                  berechtigten Interessen als auch jener der Nutzer an einem
              ...
              <ul className='m-elements'>
                  ...
                  <li>
                      ...
                      Die Profile der Nutzer sind öffentlich nicht sichtbar und
                      nicht zugänglich.
                  </li>
                  <li>
                      <strong>Löschung von Daten nach Kündigung: </strong>Wenn
                      Nutzer ihr Nutzerkonto gekündigt haben, werden deren Daten
                      im Hinblick auf das Nutzerkonto, vorbehaltlich einer
                      gesetzlichen Erlaubnis, Pflicht oder Einwilligung der
                      Nutzer, gelöscht;{' '}
                      <span className=''>
                          <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                          und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit.
              ...
              <p className={styles.paragraph}>
                  Als &quot;Single-Sign-On“ oder &quot;Single-Sign-On-Anmeldung
                  bzw. &quot;-Authentifizierung“ werden Verfahren bezeichnet,
                  die es Nutzern erlauben, sich mit Hilfe eines Nutzerkontos bei
                  einem Anbieter von Single-Sign-On-Verfahren (z.B. einem
                  sozialen Netzwerk), auch bei unserem Onlineangebot,
                  anzumelden. Voraussetzung der Single-Sign-On-Authentifizierung
                  ist, dass die Nutzer bei dem jeweiligen
                  Single-Sign-On-Anbieter registriert sind und die
                  erforderlichen Zugangsdaten in dem dafür vorgesehenen
              ...
              <p className={styles.paragraph}>
                  ...
                  jeweiligen Single-Sign-On-Anbieter eingeloggt ist und eine für
                  uns für andere Zwecke nicht weiter nutzbare ID (sog &quot;User
                  Handle“). Ob uns zusätzliche Daten übermittelt werden, hängt
                  allein von dem genutzten Single-Sign-On-Verfahren ab, von den
                  gewählten Datenfreigaben im Rahmen der Authentifizierung und
                  zudem davon, welche Daten Nutzer in den Privatsphäre- oder
              ...
              <p className={styles.paragraph}>
                  ...
                  Single-Sign-On-Anbieter abgeglichen werden können, dies jedoch
                  nicht immer möglich ist oder tatsächlich erfolgt. Ändern sich
                  z.B. die E-Mail-Adressen der Nutzer, müssen sie diese manuell
                  in ihrem Nutzerkonto bei uns ändern.
              </p>
              <p className={styles.paragraph}>
                  ...
                  unsererseits und der Interessen der Nutzer an einem effektiven
              ...
              <p className={styles.paragraph}>
                  ...
                  Verbindung innerhalb ihres Nutzerkontos beim
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      Authentifizierungsdienst; <strong>
                          Dienstanbieter:
                      </strong>{' '}
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      (z.B. E-Mail, Telefonnummern); Inhaltsdaten (z.B. Eingaben
                      in Onlineformularen); Nutzungsdaten (z.B. besuchte
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      mitgeteilten Anliegens;{' '}
                      <span className=''>
                          <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                          und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit.
                          b) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1
                          lit. f) DSGVO).{' '}
                      </span>
                  </li>
              </ul>
              ...
              <p className={styles.paragraph}>
                  ...
                  anderweitig Feedback geben, gelten zusätzlich die Allgemeinen
                  Geschäfts- oder Nutzungsbedingungen und die
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      Informationen anzeigt. Es kann z.B. in Form eines Siegels
                      oder vergleichbaren Elements, zum Teil auch
                      &quot;Badge&quot; genannt, dargestellt werden. Dabei wird
                      der entsprechende Inhalt des Widgets zwar innerhalb
              ...
              <p className={styles.paragraph}>
                  ...
                  Grafiken, auch als &quot;Web Beacons&quot; bezeichnet) für
                  ...
                  technische Informationen zum Browser und zum Betriebssystem,
                  zu verweisenden Webseiten, zur Besuchszeit sowie weitere
              ...
              <ul className='m-elements'>
                  <li>
                      ...
                      IP-Adresse der Nutzer und können diese zu Zwecken
                      der Übermittlung der Software an den Browser der Nutzer
                      sowie zu Zwecken der Sicherheit, als auch zur Auswertung
                  ...
                  <li>
                      ...
                      werden auf unserem Server gehostet, es werden keine Daten
                      an den Anbieter von Font Awesome übermittelt;{' '}
                      <span className=''>
                          <strong>Rechtsgrundlagen:</strong> Berechtigte
                          Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).{' '}
                      </span>
