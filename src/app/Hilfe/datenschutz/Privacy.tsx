    ...
    return (
        <div className='flex justify-center w-full'>
            <div className='w-1/2'>
                ...
                <h2 className={styles.heading2} id='m4158'>
                    Präambel
                </h2>
                ...
                <p className={styles.paragraph}>Stand: 19. August 2023</p>
                <h2 className={styles.heading2}>Inhaltsübersicht</h2>
                <ul className={styles.index}>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m4158'>
                            Präambel
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m3'>
                            Verantwortlicher
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#mOverview'>
                            Übersicht der Verarbeitungen
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m2427'>
                            Maßgebliche Rechtsgrundlagen
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m27'>
                            Sicherheitsmaßnahmen
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m12'>
                            Löschung von Daten
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m10'>
                            Rechte der betroffenen Personen
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m134'>
                            Einsatz von Cookies
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m317'>
                            Geschäftliche Leistungen
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m326'>
                            Zahlungsverfahren
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m225'>
                            Bereitstellung des Onlineangebotes und Webhosting
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m367'>
                            Registrierung, Anmeldung und Nutzerkonto
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m451'>
                            Single-Sign-On-Anmeldung
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m182'>
                            Kontakt- und Anfragenverwaltung
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m299'>
                            Kundenrezensionen und Bewertungsverfahren
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m328'>
                            Plugins und eingebettete Funktionen sowie Inhalte
                        </a>
                    </li>
                    <li key={uniqueId()} className={styles.index_link}>
                        <a className={styles.index_link} href='#m15'>
                            Änderung und Aktualisierung der Datenschutzerklärung
                        </a>
                    </li>
                </ul>
                <h2 className={styles.heading2} id='m3'>
                    Verantwortlicher
                </h2>
                <p className={styles.paragraph}>
                    Euro Asia Import&Export <br />
                    Horbeller Str. 9, <br />
                    50858 Köln, Germany <br />
                    E-Mail-Adresse: info@phone2door.com
                </p>
                <h2 className={styles.heading2} id='m2427'>
                    Maßgebliche Rechtsgrundlagen
                </h2>
                <p className={styles.paragraph}>
                    <strong>
                ...
                <p className={styles.paragraph}>
                    ...
                    Datenschutzgrundverordnung (DSGVO). Aus diesem Grund bitten
                    wir Sie zu beachten, dass aufgrund der breiteren räumlichen
                ...
                <h3 className={styles.heading3}>Zwecke der Verarbeitung</h3>
                <ul>
                    <li>
                ...
                <h2 className={styles.heading2} id='m27'>
                    Sicherheitsmaßnahmen
                </h2>
                <p className={styles.paragraph}>
                ...
                <h2 className={styles.heading2} id='m12'>
                    Löschung von Daten
                </h2>
                <p className={styles.paragraph}>
                    ...
                    Zweck nicht erforderlich sind). Sofern die Daten nicht
                    gelöscht werden, weil sie für andere und gesetzlich
                    zulässige Zwecke erforderlich sind, wird deren Verarbeitung
                    auf diese Zwecke beschränkt. D.h., die Daten werden gesperrt
                    und nicht für andere Zwecke verarbeitet. Das gilt z.B. für
                ...
                <p className={styles.paragraph}>
                    Unsere Datenschutzhinweise können ferner weitere Angaben zu
                    der Aufbewahrung und Löschung von Daten beinhalten, die für
                    die jeweiligen Verarbeitungen vorrangig gelten.
                </p>
                <h2 className={styles.heading2} id='m10'>
                    Rechte der betroffenen Personen
                </h2>
                <p className={styles.paragraph}>
                ...
                <h2 className={styles.heading2} id='m134'>
                    Einsatz von Cookies
                </h2>
                <p className={styles.paragraph}>
                    ...
                    ferner zu unterschiedlichen Zwecken eingesetzt werden, z.B.
                    zu Zwecken der Funktionsfähigkeit, Sicherheit und Komfort
                ...
                <p className={styles.paragraph}>
                    ...
                    Daher holen wir von den Nutzern eine vorhergehende
                    ...
                    Informationen, also auch von Cookies, unbedingt erforderlich
                    sind, um dem den Nutzern einen von ihnen ausdrücklich
                    gewünschten Telemediendienst (also unser Onlineangebot) zur
                    Verfügung zu stellen. Zu den unbedingt erforderlichen
                    Cookies gehören in der Regel Cookies mit Funktionen, die der
                    ...
                    Onlineangebotes zusammenhängenden Zwecken dienen. Die
                    widerrufliche Einwilligung wird gegenüber den Nutzern
                ...
                <p className={styles.paragraph}>
                    ...
                    vertraglichen Pflichten erfolgt, wenn der Einsatz von
                    Cookies erforderlich ist, um unsere vertraglichen
                    Verpflichtungen zu erfüllen. Zu welchen Zwecken die Cookies
                    von uns verarbeitet werden, darüber klären wir im Laufe
                ...
                <ul>
                    <li>
                        ...
                         Temporäre Cookies werden spätestens gelöscht, nachdem
                        ein Nutzer ein Online-Angebot verlassen und sein
                        Endgerät (z.B. Browser oder mobile Applikation)
                        geschlossen hat.
                    </li>
                    <li>
                        <strong>Permanente Cookies:</strong> Permanente Cookies
                        bleiben auch nach dem Schließen des Endgerätes
                        gespeichert. So können beispielsweise der Login-Status
                        gespeichert oder bevorzugte Inhalte direkt angezeigt
                        werden, wenn der Nutzer eine Website erneut besucht.
                        Ebenso können die mit Hilfe von Cookies erhobenen Daten
                        der Nutzer zur Reichweitenmessung verwendet werden.
                        Sofern wir Nutzern keine expliziten Angaben zur Art und
                        Speicherdauer von Cookies mitteilen (z. B. im Rahmen der
                        Einholung der Einwilligung), sollten Nutzer davon
                ...
                <p className={styles.paragraph}>
                    ...
                    gesetzlichen Vorgaben widersprechen. Hierzu können Nutzer
                    unter anderem die Verwendung von Cookies in den
                    ...
                    Verwendung von Cookies zu Online-Marketing-Zwecken kann auch
                    über die Websites{' '}
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Cookie-Einwilligungs-Management ein, in dessen Rahmen
                        die Einwilligungen der Nutzer in den Einsatz von
                        Cookies, bzw. der im Rahmen des
                        Cookie-Einwilligungs-Management-Verfahrens genannten
                        Verarbeitungen und Anbieter eingeholt sowie von den
                        Nutzern verwaltet und widerrufen werden können. Hierbei
                        ...
                        und/oder in einem Cookie (sogenanntes Opt-In-Cookie,
                        bzw. mithilfe vergleichbarer Technologien) erfolgen, um
                        die Einwilligung einem Nutzer, bzw. dessen Gerät
                        zuordnen zu können. Vorbehaltlich individueller Angaben
                        zu den Anbietern von Cookie-Management-Diensten, gelten
                        die folgenden Hinweise: Die Dauer der Speicherung der
                        Einwilligung kann bis zu zwei Jahren betragen. Hierbei
                        wird ein pseudonymer Nutzer-Identifikator gebildet und
                        mit dem Zeitpunkt der Einwilligung, Angaben zur
                        Reichweite der Einwilligung (z. B. welche Kategorien von
                        Cookies und/oder Diensteanbieter) sowie dem Browser,
                ...
                <h2 className={styles.heading2} id='m317'>
                    Geschäftliche Leistungen
                </h2>
                <p className={styles.paragraph}>
                ...
                <p className={styles.paragraph}>
                    ...
                    Darüber hinaus verarbeiten wir die Daten auf Grundlage
                    ...
                    weitere Formen der Verarbeitung, z.B. zu Marketingzwecken,
                ...
                <p className={styles.paragraph}>
                    ...
                    grundsätzlich nach Ablauf von 4 Jahren, es sei denn, dass
                    die Daten in einem Kundenkonto gespeichert werden, z.B.,
                    ...
                    bei empfangenen Handels- und Geschäftsbriefen und
                    Wiedergaben der abgesandten Handels- und Geschäftsbriefe
                    sechs Jahre. Die Frist beginnt mit Ablauf des
                    Kalenderjahres, in dem die letzte Eintragung in das Buch
                    gemacht, das Inventar, die Eröffnungsbilanz, der
                    Jahresabschluss oder der Lagebericht aufgestellt, der
                    Handels- oder Geschäftsbrief empfangen oder abgesandt worden
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Kundenkategorie); Nutzungsdaten (z.B. besuchte
                    ...
                    <li>
                        ...
                        Pflichten; Sicherheitsmaßnahmen; Kontaktanfragen und
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Registrierung sowie anschließender Anmeldungen und
                        Nutzungen des Kundenkontos speichern wir die IP-Adressen
                        der Kunden nebst den Zugriffszeitpunkten, um die
                        Registrierung nachweisen und etwaigem Missbrauch des
                        Kundenkontos vorbeugen zu können. Wurde das Kundenkonto
                        gekündigt, werden die Daten des Kundenkontos nach dem
                        Kündigungszeitpunkt gelöscht, sofern sie nicht für
                        andere Zwecke als die Bereitstellung im Kundenkonto
                        aufbewahrt werden oder aus rechtlichen Gründen
                        aufbewahrt werden müssen (z.B. interne Speicherung von
                        Kundendaten, Bestellvorgängen oder Rechnungen). Es liegt
                        in der Verantwortung der Kunden, ihre Daten bei
                    ...
                    <li>
                        <strong>Shop und E-Commerce: </strong>Wir verarbeiten
                        die Daten unserer Kunden, um ihnen die Auswahl, den
                        Erwerb, bzw. die Bestellung der gewählten Produkte,
                        Waren sowie verbundener Leistungen, als auch deren
                        Bezahlung und Zustellung, bzw. Ausführung zu
                        ermöglichen. Sofern für die Ausführung einer Bestellung
                        erforderlich, setzen wir Dienstleister, insbesondere
                        Post-, Speditions- und Versandunternehmen ein, um die
                        Lieferung, bzw. Ausführung gegenüber unseren Kunden
                        durchzuführen. Für die Abwicklung der Zahlungsvorgänge
                        nehmen wir die Dienste von Banken und
                        Zahlungsdienstleistern in Anspruch. Die erforderlichen
                        Angaben sind als solche im Rahmen des Bestell- bzw.
                        vergleichbaren Erwerbsvorgangs gekennzeichnet und
                        umfassen die zur Auslieferung, bzw. Zurverfügungstellung
                        und Abrechnung benötigten Angaben sowie
                        Kontaktinformationen, um etwaige Rücksprache halten zu
                        können;{' '}
                        <span className=''>
                            <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                            und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
                ...
                <h2 className={styles.heading2} id='m326'>
                    Zahlungsverfahren
                </h2>
                <p className={styles.paragraph}>
                    Im Rahmen von Vertrags- und sonstigen Rechtsbeziehungen,
                    aufgrund gesetzlicher Pflichten oder sonst auf Grundlage
                ...
                <p className={styles.paragraph}>
                    ...
                    Passwörter, TANs und Prüfsummen sowie die Vertrags-, Summen-
                    und empfängerbezogenen Angaben. Die Angaben sind
                ...
                <p className={styles.paragraph}>
                    ...
                    Zahlungsdienstleister, welche innerhalb der jeweiligen
                    Webseiten bzw. Transaktionsapplikationen abrufbar sind. Wir
                    verweisen auf diese ebenfalls zwecks weiterer Informationen
                    und Geltendmachung von Widerrufs-, Auskunfts- und anderen
                    Betroffenenrechten.
                </p>
                <ul className='m-elements'>
                    <li>
                ...
                <ul className='m-elements'>
                    <li>
                        <strong>Stripe: </strong>Zahlungsdienstleistungen
                        (technische Anbindung von Online-Bezahlmethoden);{' '}
                        <strong>Dienstanbieter:</strong> Stripe, Inc., 510
                        Townsend Street, San Francisco, CA 94103, USA;{' '}
                        <span className=''>
                            <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                            und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
                            lit. b) DSGVO);{' '}
                ...
                <h2 className={styles.heading2} id='m225'>
                    Bereitstellung des Onlineangebotes und Webhosting
                </h2>
                <p className={styles.paragraph}>
                ...
                <ul className='m-elements'>
                    ...
                    <li>
                        ...
                        zum einen zu Zwecken der Sicherheit eingesetzt werden,
                    ...
                    <li>
                        <strong>E-Mail-Versand und -Hosting: </strong>Die von
                        uns in Anspruch genommenen Webhosting-Leistungen
                        umfassen ebenfalls den Versand, den Empfang sowie die
                        Speicherung von E-Mails. Zu diesen Zwecken werden die
                        Adressen der Empfänger sowie Absender als auch weitere
                        Informationen betreffend den E-Mailversand (z.B. die
                        beteiligten Provider) sowie die Inhalte der jeweiligen
                        E-Mails verarbeitet. Die vorgenannten Daten können
                        ferner zu Zwecken der Erkennung von SPAM verarbeitet
                        werden. Wir bitten darum, zu beachten, dass E-Mails im
                        Internet grundsätzlich nicht verschlüsselt versendet
                        werden. Im Regelfall werden E-Mails zwar auf dem
                    ...
                    <li>
                        <strong>Checkdomain: </strong>Leistungen auf dem Gebiet
                        ...
                        <strong>Dienstanbieter:</strong> checkdomain GmbH, a
                        dogado group company, Große Burgstraße 27/29, 23552
                        Lübeck, Deutschland;{' '}
                        <span className=''>
                            <strong>Rechtsgrundlagen:</strong> Berechtigte
                            Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO);{' '}
                        ...
                        . <strong>Auftragsverarbeitungsvertrag:</strong> Wird
                        vom Dienstanbieter bereitgestellt.
                    </li>
                </ul>
                <h2 className={styles.heading2} id='m367'>
                    Registrierung, Anmeldung und Nutzerkonto
                </h2>
                <p className={styles.paragraph}>
                    Nutzer können ein Nutzerkonto anlegen. Im Rahmen der
                    Registrierung werden den Nutzern die erforderlichen
                    Pflichtangaben mitgeteilt und zu Zwecken der Bereitstellung
                    des Nutzerkontos auf Grundlage vertraglicher
                    Pflichterfüllung verarbeitet. Zu den verarbeiteten Daten
                    gehören insbesondere die Login-Informationen (Nutzername,
                ...
                <p className={styles.paragraph}>
                    ...
                    Grundlage unserer berechtigten Interessen als auch jener der
                    Nutzer an einem Schutz vor Missbrauch und sonstiger
                    unbefugter Nutzung. Eine Weitergabe dieser Daten an Dritte
                    erfolgt grundsätzlich nicht, es sei denn, sie ist zur
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Onlineformularen). Meta-, Kommunikations- und
                        Verfahrensdaten (z. B. IP-Adressen, Zeitangaben,
                        Identifikationsnummern, Einwilligungsstatus).
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Erbringung
                        vertraglicher Leistungen und erfüllung vertraglicher
                        Pflichten; Sicherheitsmaßnahmen; Verwaltung und
                        Beantwortung von Anfragen. Bereitstellung unseres
                ...
                <ul className='m-elements'>
                    <li>
                        <strong>Registrierung mit Pseudonymen: </strong>Nutzer
                        dürfen statt Klarnamen Pseudonyme als Nutzernamen
                        verwenden;{' '}
                        <span className=''>
                            <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                            und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
                    ...
                    <li>
                        ...
                        Die Profile der Nutzer sind öffentlich nicht sichtbar
                        und nicht zugänglich.
                    </li>
                    <li>
                        <strong>Löschung von Daten nach Kündigung: </strong>Wenn
                        Nutzer ihr Nutzerkonto gekündigt haben, werden deren
                        Daten im Hinblick auf das Nutzerkonto, vorbehaltlich
                        einer gesetzlichen Erlaubnis, Pflicht oder Einwilligung
                        der Nutzer, gelöscht;{' '}
                        <span className=''>
                            <strong>Rechtsgrundlagen:</strong> Vertragserfüllung
                            und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
                ...
                <h2 className={styles.heading2} id='m451'>
                    Single-Sign-On-Anmeldung
                </h2>
                <p className={styles.paragraph}>
                    ...
                    Single-Sign-On-Authentifizierung ist, dass die Nutzer bei
                    dem jeweiligen Single-Sign-On-Anbieter registriert sind und
                    die erforderlichen Zugangsdaten in dem dafür vorgesehenen
                    Onlineformular eingeben, bzw. schon bei dem
                    Single-Sign-On-Anbieter angemeldet sind und die
                    Single-Sign-On-Anmeldung via Schaltfläche bestätigen.
                </p>
                <p className={styles.paragraph}>
                    Die Authentifizierung erfolgt direkt bei dem jeweiligen
                    Single-Sign-On-Anbieter. Im Rahmen einer solchen
                    Authentifizierung erhalten wir eine Nutzer-ID mit der
                ...
                <p className={styles.paragraph}>
                    ...
                    Single-Sign-On-Anbieter abgeglichen werden können, dies
                    jedoch nicht immer möglich ist oder tatsächlich erfolgt.
                    Ändern sich z.B. die E-Mail-Adressen der Nutzer, müssen sie
                    diese manuell in ihrem Nutzerkonto bei uns ändern.
                </p>
                <p className={styles.paragraph}>
                    Die Single-Sign-On-Anmeldung können wir, sofern mit den
                    Nutzern vereinbart, im Rahmen der oder vor der
                    Vertragserfüllung einsetzen, soweit die Nutzer darum gebeten
                    wurden, im Rahmen einer Einwilligung verarbeiten und setzen
                    sie ansonsten auf Grundlage der berechtigten Interessen
                    unsererseits und der Interessen der Nutzer an einem
                    effektiven und sicheren Anmeldesystem ein.
                </p>
                <p className={styles.paragraph}>
                    Sollten Nutzer sich einmal entscheiden, die Verknüpfung
                    ihres Nutzerkontos beim Single-Sign-On-Anbieter nicht mehr
                    für das Single-Sign-On-Verfahren nutzen zu wollen, müssen
                    sie diese Verbindung innerhalb ihres Nutzerkontos beim
                    Single-Sign-On-Anbieter aufheben. Möchten Nutzer deren Daten
                    bei uns löschen, müssen sie ihre Registrierung bei uns
                    kündigen.
                </p>
                <ul className='m-elements'>
                    <li>
                    ...
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Erbringung
                        vertraglicher Leistungen und erfüllung vertraglicher
                        Pflichten; Sicherheitsmaßnahmen. Anmeldeverfahren.
                    </li>
                    <li key={uniqueId()} className=''>
                        <strong>Rechtsgrundlagen:</strong> Berechtigte
                        Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                ...
                <h2 className={styles.heading2} id='m182'>
                    Kontakt- und Anfragenverwaltung
                </h2>
                <p className={styles.paragraph}>
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        (z.B. E-Mail, Telefonnummern); Inhaltsdaten (z.B.
                        Eingaben in Onlineformularen); Nutzungsdaten (z.B.
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Kontaktformular, E-Mail oder andere Kommunikationswege
                        mit uns in Kontakt treten, verarbeiten wir die uns in
                        diesem Zusammenhang mitgeteilten Daten zur Bearbeitung
                ...
                <h2 className={styles.heading2} id='m299'>
                    Kundenrezensionen und Bewertungsverfahren
                </h2>
                <p className={styles.paragraph}>
                    Wir nehmen an Rezensions- und Bewertungsverfahren teil, um
                    unsere Leistungen zu evaluieren, zu optimieren und zu
                    bewerben. Wenn Nutzer uns über die beteiligten
                    Bewertungsplattformen oder -verfahren bewerten oder
                    anderweitig Feedback geben, gelten zusätzlich die
                    Allgemeinen Geschäfts- oder Nutzungsbedingungen und die
                    Datenschutzhinweise der Anbieter. Im Regelfall setzt die
                    Bewertung zudem eine Registrierung bei den jeweiligen
                    Anbietern voraus.{' '}
                </p>
                <p className={styles.paragraph}>
                    Um sicherzustellen, dass die bewertenden Personen
                    tatsächlich unsere Leistungen in Anspruch genommen haben,
                    übermitteln wir mit Einwilligung der Kunden die hierzu
                    erforderlichen Daten im Hinblick auf den Kunden und die in
                    Anspruch genommene Leistung an die jeweilige
                    Bewertungsplattform (einschließlich Name, E-Mail-Adresse und
                    Bestellnummer bzw. Artikelnummer). Diese Daten werden
                    alleine zur Verifizierung der Authentizität des Nutzers
                    verwendet.
                </p>
                <ul className='m-elements'>
                    <li>
                    ...
                    <li>
                        <strong>Betroffene Personen:</strong> Kunden. Nutzer
                ...
                <h2 className={styles.heading2} id='m328'>
                    Plugins und eingebettete Funktionen sowie Inhalte
                </h2>
                <p className={styles.paragraph}>
                ...
                <p className={styles.paragraph}>
                    ...
                    dieser Inhalte oder Funktionen erforderlich. Wir bemühen
                ...
                <ul className='m-elements'>
                    <li>
                        ...
                        Wir binden in unser Onlineangebot Software ein, die wir
                        von Servern anderer Anbieter abrufen (z.B.
                        Funktions-Bibliotheken, die wir zwecks Darstellung oder
                        Nutzerfreundlichkeit unseres Onlineangebotes verwenden).
                        Hierbei erheben die jeweiligen Anbieter die IP-Adresse
                        der Nutzer und können diese zu Zwecken der Übermittlung
                        der Software an den Browser der Nutzer sowie zu Zwecken
                        der Sicherheit, als auch zur Auswertung und Optimierung
                        ihres Angebotes verarbeiten. - Wir binden in unser
                        Onlineangebot Software ein, die wir von Servern anderer
                        Anbieter abrufen (z.B. Funktions-Bibliotheken, die wir
                        zwecks Darstellung oder Nutzerfreundlichkeit unseres
                        Onlineangebotes verwenden). Hierbei erheben die
                        jeweiligen Anbieter die IP-Adresse der Nutzer und können
                        diese zu Zwecken der Übermittlung der Software an den
                        Browser der Nutzer sowie zu Zwecken der Sicherheit, als
                    ...
                    <li>
                        ...
                        <strong>Dienstanbieter:</strong> Die Font Awesome Icons
                    ...
                    <li>
                        <strong>Google Maps: </strong>Wir binden die Landkarten
                        des Dienstes “Google Maps” des Anbieters Google ein. Zu
                        den verarbeiteten Daten können insbesondere IP-Adressen
                        und Standortdaten der Nutzer gehören;{' '}
                        <strong>Dienstanbieter:</strong> Google Cloud EMEA
                ...
                <h2 className={styles.heading2} id='m15'>
                    Änderung und Aktualisierung der Datenschutzerklärung
                </h2>
                <p className={styles.paragraph}>
