...
export default function DashboardLayout({
    ...
    return (
        <section className="flex min-h-screen w-full flex-col justify-between bg-white">
            <header className="h-32 w-full flex-col items-center justify-center bg-teal-50 text-center">
                {/* Below is the mobile navigation section */}
                <section className="h-full w-full flex-col content-center items-center justify-around">
                    <div className="flex h-full w-full items-center justify-around px-5">
                        ...
                        <nav className="flex w-2/3 justify-around">
                            <FiShoppingCart size={40} style={{ stroke: "url(#coastal-mist)" }} />
                            <FiUser size={40} style={{ stroke: "url(#coastal-mist)" }} />
                            <FiMenu size={48} color="#0388A6" />
                        </nav>
                    </div>
                    <div className="mx-auto flex w-4/5 justify-end rounded-2xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 pb-[4px]">
                        <div className="flex h-full w-full justify-end rounded-xl bg-white px-3 py-1">
