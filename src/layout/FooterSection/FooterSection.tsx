        ...
        <footer>
            <footer className="footer bg-base-200 p-10 text-base-content">
                <div>
                    ...
                    <a className="link-hover link">Email</a>
                    <a className="link-hover link">Telefon</a>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link-hover link">Nutzer Bedingungen</a>
                    <a className="link-hover link">Datenschutzerklärung</a>
